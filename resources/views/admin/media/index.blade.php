    ...
    <x-slot name="header">
        <div class="dashboard-header">
            <div class="dashboard-header-content w-full">
                <div class="media-header flex items-center gap-4">
                    <div class="rounded-xl section-icon-wrap" style="padding: 0.7rem; background-color: #dbeafe; margin-top: -3px; margin-left: 1.2rem;">
                    ...
                    <div>
                        <h2 class="dashboard-title text-3xl font-bold text-gray-800 tracking-tight">Media Library</h2>
                        <p class="dashboard-welcome text-gray-500 mt-1">Kelola dan unggah aset gambar atau file lainnya.</p>
                    </div>
                </div>
            </div>
        </div>
